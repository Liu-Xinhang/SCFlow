...
train_pipeline = [
    ...
    dict(type='UnprojectDepth', depth_factor=0.1),
    dict(type='ToTensor', stack_keys=[], ),
    dict(type='Collect', 
        annot_keys=[
            'ref_rotations', 'ref_translations',  
            'gt_rotations', 'gt_translations', 'gt_masks', 'gt_depths', 'dpt_3d',
            'init_add_error', 'init_rot_error', 'init_trans_error',
            'k', 'labels'],
        meta_keys=(
            'img_path', 'ori_shape', 'ori_k', 'depth_path',
